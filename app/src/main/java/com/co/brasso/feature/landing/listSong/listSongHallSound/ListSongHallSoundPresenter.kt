...
class ListSongHallSoundPresenter : BasePresenter<ListSongHallSoundView>() {
    private var interactor: ListSongHallSoundInteractor? = null
    private var searchInteractor: SearchInteractor? = null

    override fun attachView(view: ListSongHallSoundView) {
        super.attachView(view)
        interactor = ListSongHallSoundInteractor()
