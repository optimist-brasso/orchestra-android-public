...
class SessionDetailInteractor : BaseInteractor() {
    fun getInstrumentDetail(
        ...
        InstrumentDetailRepository.getInstrumentDetail(compositeDisposable, instrumentID,sessionID,musicianId, token,videoSupport)
