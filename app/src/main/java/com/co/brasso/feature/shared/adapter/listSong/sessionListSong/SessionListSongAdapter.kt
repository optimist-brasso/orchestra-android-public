package com.co.brasso.feature.shared.adapter.listSong.sessionListSong
...
class SessionListSongAdapter(
    private var playerFavouriteList: MutableList<FavouriteSessionResponse>?,
    ...
    override fun onBindViewHolder(holder: BaseViewHolder, position: Int) {
        when (getItemViewType(position)) {
            Constants.playerListViewType -> {
                ...
                holder.setFavourite(binding.root.context,favouritePlayer)
