...
class CropWindowHandler {
    ...
    fun getMoveHandler(
        ...
        val type: CropWindowMoveHandler.Type? = when (cropShape) {
            CropImageView.CropShape.RECTANGLE -> getRectanglePressedMoveType(x, y, targetRadius, isCenterMoveEnabled)
            CropImageView.CropShape.OVAL -> getOvalPressedMoveType(x, y, isCenterMoveEnabled)
            CropImageView.CropShape.RECTANGLE_VERTICAL_ONLY -> getRectangleVerticalOnlyPressedMoveType(x, y, targetRadius, isCenterMoveEnabled)
            CropImageView.CropShape.RECTANGLE_HORIZONTAL_ONLY -> getRectangleHorizontalOnlyPressedMoveType(x, y, targetRadius, isCenterMoveEnabled)
            else -> return null
        }
